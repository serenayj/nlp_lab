...
To this end, the paper proposes MUSE (Multi-LLM Uncertainty via Subset Ensembles) — an information-theoretic method that utilizes the Jensen-Shannon Divergence (JSD) to select well-calibrated subsets of LLMs and then aggregate their predictions.
